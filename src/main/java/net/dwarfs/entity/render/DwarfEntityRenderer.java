...
import net.dwarfs.entity.render.feature.DwarfHeldItemsFeatureRenderer;
...
public class DwarfEntityRenderer extends MobEntityRenderer<DwarfEntity, DwarfEntityModel<DwarfEntity>> {
    ...
    public DwarfEntityRenderer(EntityRendererFactory.Context context) {
        super(context, new DwarfEntityModel<>(context.getPart(RenderInit.DWARF_LAYER)), 0.5f);
        ...
        this.addFeature(new DwarfHeldItemsFeatureRenderer(this));
    }
