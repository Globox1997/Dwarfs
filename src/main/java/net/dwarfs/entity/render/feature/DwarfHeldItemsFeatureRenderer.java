package net.dwarfs.entity.render.feature;
...
// public class DwarfHeldItemsFeatureRenderer<T extends LivingEntity, M extends EntityModel<T>> extends FeatureRenderer<T, M> {
//     public DwarfHeldItemsFeatureRenderer(FeatureRendererContext<T, M> featureRendererContext) {
