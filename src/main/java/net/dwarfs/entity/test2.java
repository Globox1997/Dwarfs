...
// public DwarfEntity(EntityType<? extends DwarfEntity> entityType, World world, VillagerType type) {
// super(entityType, world);
...
// DwarfEntity dwarfEntity = new DwarfEntity(EntityInit.DWARF, serverWorld, villagerType);
